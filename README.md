...
Everything made by me in this project, and everything that I obtained under the Creative Commons Zero license, is hereby released under the Creative Commons Zero license. You can it all for any purpose without crediting me or doing anything special whatsoever. LICENSE.txt, a copy of the Creative Commons Zero 1.0 legal code, hereby applies to all relevant files.
...
However, keep in mind that Godot itself is licensed under the MIT license, so when you release a game/VN based on this project, you need to include its license texts alongside your game/VN in some form. The MIT license is permissive and not 'viral'; it does not restrict what you're allowed to do with your own code, or with MirageVN code. All you need to do is include the license text. For full instructions on complying with the licenses of Godot and its dependencies, see [this page](https://docs.godotengine.org/en/stable/about/complying_with_licenses.html) and [this page](https://godotengine.org/license). The specific licenses you need to include might differ depending on the specific version of Godot you're using; if this worries you, you can use Godot's built-in [`Engine.get_license_info()`](https://docs.godotengine.org/en/stable/classes/class_engine.html?highlight=license_info#class-engine-method-get-license-info) function to get the text necessary to populate a credits screen. This will always produce the correct license text, and a credits screen is a legally acceptable way to convey this text to your users.
